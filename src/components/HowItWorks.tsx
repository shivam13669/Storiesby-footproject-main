    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {/* Steps grid */}
          <div className="grid md:grid-cols-4 gap-8 relative auto-rows-fr">
            {steps.map((step, index) => (
              ...
              >
                ...
                <div className="pt-16 pb-8 px-7 rounded-3xl bg-gradient-to-b from-white to-green-50 border border-green-200 border-opacity-15 shadow-lg hover:shadow-2xl transition-all duration-350 group-hover:-translate-y-2.5 bg-opacity-80 backdrop-blur-sm h-full flex flex-col">
                  ...
                  {/* Text */}
                  <h3 className="text-2xl font-bold text-slate-900 mb-3 text-center flex-shrink-0">
                    {step.title}
                  </h3>
                  <p className="text-slate-600 text-center text-base leading-relaxed flex-grow">
                    {step.description}
                  </p>
                </div>
              </div>
