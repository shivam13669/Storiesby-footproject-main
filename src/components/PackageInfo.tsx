...
const PackageInfo = ({ duration, title }: PackageInfoProps) => {
  return (
    <div className="mb-8">
      <h1 className="text-3xl font-bold text-foreground mb-4" style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 600 }}>
        {title}
      </h1>

      <div className="flex flex-wrap items-center gap-4 mb-6">
        <span className="badge-duration font-bold" style={{ fontFamily: "'Poppins', sans-serif" }}>{duration}</span>
      </div>
