                ...
                {[
                  ...
                  <li key={item.label}>
                    {item.path.startsWith("/") ? (
                      <Link to={item.path} className="text-white/80 hover:text-adventure-gold transition-colors">
                        {item.label}
                      </Link>
                    ) : (
                      <a href={item.path} className="text-white/80 hover:text-adventure-gold transition-colors">
                        {item.label}
                      </a>
                    )}
                  </li>
