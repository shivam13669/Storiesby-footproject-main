        ...
        <div className="mt-8">
          ...
          <PolicyAccordion title="Cancellation Policy" defaultOpen={true}>
            <ul className="space-y-2 list-disc pl-5">
              ...
              <li>In the event of unforeseen weather conditions, union issues, government restrictions, or any other circumstances beyond human control, certain trips or activities may be cancelled. In such cases, alternate feasible options will be provided. However, a cash refund will not be availa
            </ul>
          </PolicyAccordion>
